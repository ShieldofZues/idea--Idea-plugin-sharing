...
|                                |                                                                                     |                                                                           |
| MyBatis Log Plugin | 将 Mybatis 执行的 sql 脚本显示出来，无需处理，可以直接复制出来执行的 |https://plugins.jetbrains.com/plugin/10065-mybatis-log-plugin | 
|                                |                                                                                     |                                                                           |
| stackoverflow | 这一看似平淡的右键 stackoverflow，却把其中的闷骚体现的淋漓尽致：我就这么叼，我就不去浏览器里查，只有右键才和我的右手匹配。 |https://plugins.jetbrains.com/plugin/9513-stackoverflow |
|                                |                                                                                     |                                                                           |
